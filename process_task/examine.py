...
"""
from https://stackoverflow.com/a/54497847/2077242
...
def b64_to_long(file_id):
    """google file ids look like (possibly broken) base64 urlsafe"""
    file_id = str(file_id)
    try:
        d = base64.urlsafe_b64decode(file_id + "==")
    except Exception:
        d = base64.urlsafe_b64decode(file_id + "A==")
    # python 2 only
